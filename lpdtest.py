...
if sys.stdin.isatty():
    ...
    print("lpdtest.py 192.168.0.20 < testpage.pdf")
    print('echo "This is a test" | ./lpdtest.py 192.168.0.20')
    exit()
...
lpd_send(lpd_command('02', [length_string, b"cfa001lpdtesthost"]))
print("Sending job recv command")
length_string = bytes(str(data_length), 'ascii')
lpd_send(lpd_command('03', [length_string, b"dfa001lpdtesthost"]))
